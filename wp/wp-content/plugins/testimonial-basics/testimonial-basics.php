<?php
/*
Plugin Name: Testimonial Basics2
Plugin URI: 
Description: This is a forked version of the original plugin which provides complete comprehensive management of customer testimonials. The user can set up an input form in a page or in a widget, and display all or selected testimonials in a page or a widget. The plug in is very easy to use and modify.
Version: 4.3.1
Author: scott shipman
Author URI: http://ibuilddrupalsites.com
License: GPLv3
Text Domain: testimonial-basics2
===================================================================================================
                       LICENSE
===================================================================================================
